...
field.SetDisabled(true)          // Deaktiviert: UI gesperrt (ab xiri-ng 0.4.14), Wert wird serverseitig nie gebunden (Default); gilt für BindAndValidate und FormGroup.ParseValues/Tabellenfilter (LoadFilterData)
